...
*Note: if you'd like your classmates to code along with you, please let the class know ahead of time so we can send out an announcement describing how to install the package you'll be covering.*
...
Like your homework assignments (see [homework guidelines](homework-guidelines.md) for details), you will author your write up in [Quarto](https://quarto.org/). Please render your Quarto documents to HTML. Your write up should be submitted in the Assignments section of BrightSpace.

Which files to submit:

-   A zip file of everything in your project folder.
-   But you should make it easy for your TA to know which files to focus on
...
Remember to show us the skills you've picked up in the course. Use the `tidyverse` to your advantage. It should be your main data wrangle/viz tool. You should also make your Quarto shine. Bring the Quarto skills you've picked up from completing the homework into your final project write-up.
